...
function Contact() {
    ...
    return (
        <>
            <div className="bg-gradient-to-r from-yellow-500 to-green-500 w-full inline-flex " id="contacts">
                <div className="px-20 py-14 text-white w-1/2">
                    <h1 className="text-4xl font-bold ">Lets discuss <br /> Your project</h1>
                    <p className="mt-9">Let's figure out how to create an effective application, <br /> its cost and terms of its development</p>
                </div>
