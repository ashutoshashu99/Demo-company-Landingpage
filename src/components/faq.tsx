...
function Faq() {
  return (
    <>
      <div className="p-20 ">
        <div className="text-4xl font-semibold" id="faq">
          FAQ
        </div>
          ...
          <div className=" w-1/2">
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="text-slate-600">
                ...
                cumque laborum quod ipsum ea nobis adipisci? Amet vel sapiente
                at!
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent className="text-slate-600">
                ...
                voluptatum ex facilis eos, ea corrupti a neque quos sed ipsa
                repellendus id, voluptatibus soluta officiis exercitationem
                cupiditate suscipit obcaecati sint molestiae, eum velit animi!
                Perspiciatis doloribus numquam iusto alias illum.
              </AccordionContent>
            </AccordionItem>
          </div>
          <div className="w-1/2">
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent className="text-slate-600">
                ...
                porro dolor ipsam? Quam natus neque necessitatibus qui
                perspiciatis, rem modi quibusdam ducimus ea. Voluptate qui,
                quibusdam at minima asperiores nostrum porro earum atque nihil
                nulla rerum explicabo ex consequatur ducimus!
              </AccordionContent>
            </AccordionItem>
          </div>
        </Accordion>
